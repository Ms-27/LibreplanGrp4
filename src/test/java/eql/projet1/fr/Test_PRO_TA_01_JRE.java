...
public class Test_PRO_TA_01_JRE {
	...
	public void testCreationProjet() throws InterruptedException {
		...
		assertTrue(page_projet.project_edit_ico.isDisplayed());
		assertTrue(page_projet.project_supp_ico.isDisplayed());
		assertTrue(page_projet.project_plan_ico.isDisplayed());
		assertTrue(page_projet.project_model_ico.isDisplayed());
